...
class _DenseLayer(nn.Sequential):
    def __init__(self,
        ...
        _, norm1 = build_norm_layer(
            sw_cfg if sw_cfg is not None else norm_cfg, num_input_features)
    ...
    def __init__(self,
        ...
        for i in range(num_layers):
            layer = _DenseLayer(
                ...
                drop_rate,
                norm_cfg=norm_cfg,
                sw_cfg=sw_cfg if i % 3 == 0 else None)
...
class DenseNet(nn.Module):
    ...
    def __init__(self,
        ...
        _, norm0 = build_norm_layer(
            sw_cfg if sw_cfg is not None else norm_cfg, num_init_features)
        ...
        for i, num_layers in enumerate(block_config):
            block = _DenseBlock(num_layers=num_layers,
                                ...
                                drop_rate=drop_rate,
                                norm_cfg=norm_cfg,
                                sw_cfg=sw_cfg if stage_with_sw[i] else None)
